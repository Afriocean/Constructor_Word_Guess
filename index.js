...
const wordBank = [
  "dior", "versace", "prada",
  "burberry", "hugo boss", "polo",
  "armani", "tom ford", "calvin klein",
  "gucci", "mont blanc", "paco rabanne",
  "jimmy choo"
];
...
function init() {
  pickedWords = [];
  console.log("Hello, and welcome to Word Guess in Cologne!");
  console.log("------------------------------------------");
  playGame();
}
...
function playGame() {
  ...
  if(pickedWords.length < wordBank.length) {
    ...
    // WIN CONDITION
    console.log("You know a lot about your men cologne. Yep!");
    continuePrompt();
  }
  if(pickedWord) {
